...
from testScraper.post_repository import PostRepository
...
class PostService:
    ...
    @classmethod
    def extractUrl(self, response, config, publisherId, publisherName):
        articleList = []
        urlList = []
    ...
    def parseFromService(self, response):
        ...
        articlesUrls = self.extractUrl(response, config, publisherId, publisherName)
